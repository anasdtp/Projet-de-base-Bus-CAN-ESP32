...
extern CANMessage rxMsg[SIZE_FIFO];//data received by CAN to control the robot //Voir .cpp pour + de coms
extern CANMessage txMsg;//DATA that the robot will write on CAN
